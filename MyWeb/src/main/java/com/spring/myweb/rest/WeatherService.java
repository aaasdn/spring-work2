   ...
   public void getShortTermForecast(String area1, String area2) {
      ...
      try {
         StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst"); /*URL*/
          urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=64UwtriBEbQgzK%2BJ%2Bdt5NoDl6trxQE8t2q8CwaoGybS2yMf%2FS%2BDXxvlQla3K77aCd44ShzVbzW%2BsBuzO4hfsyg%3D%3D"); /*Service Key*/
...
//		    System.out.println(sb.toString());
		    ...
		    //jsonString(json데이터)를 넣어 JSON Object로 만들어준다.
